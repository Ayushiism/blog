  ...
  return (
    <div>
        ...
        <div className='social-icon'>
            <button className='twitter'><div className='wrapper'><img className='social-logo' src={twitter}></img><a href={topic.twitter} style={{textDecoration: 'none'}}>TWITTER</a></div></button>
            <button className='linkedin'><div className='wrapper'><img className='social-logo' src={linkedin}></img><a href={topic.linkedin} style={{textDecoration: 'none'}}>LINKEDIN</a></div></button>
            <button className='medium'><div className='wrapper'><img className='social-logo' src={medium}></img><a href={topic.medium} style={{textDecoration: 'none'}}>MEDIUM</a></div></button>
        </div>
        </div>
        <div className='box'>
